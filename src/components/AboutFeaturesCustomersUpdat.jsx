import styles from "./AboutFeaturesCustomersUpdat.module.css";

const AboutFeaturesCustomersUpdat = () => {
  return (
    <section className={styles.aboutFeaturesCustomersUpdat}>
...
export default AboutFeaturesCustomersUpdat;
